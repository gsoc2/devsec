...
void test_OS_IntegratorD(void **state) {
    ...
    expect_string(__wrap__mdebug1, formatted_msg, "Running script with args: integrations /tmp/virustotal-1111-2222.alert 123456  NOTSET  > /dev/null 2>&1");
    ...
    expect_string(__wrap__mdebug1, formatted_msg, "Running script with args: integrations /tmp/pagerduty-1111-2222.alert 123456  WARNING /tmp/pagerduty-1111-2222.options");
